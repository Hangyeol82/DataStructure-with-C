...
void test_case_1() {
    ...
    add_edge(0,1,4); add_edge(1,0,4);
    add_edge(0,7,8); add_edge(7,0,8);
    add_edge(1,2,8); add_edge(2,1,8);
    add_edge(1,7,11); add_edge(7,1,11);
    add_edge(2,3,7); add_edge(3,2,7);
    add_edge(2,5,4); add_edge(5,2,4);
    add_edge(2,8,2); add_edge(8,2,2);
    add_edge(3,4,9); add_edge(4,3,9);
    add_edge(3,5,14); add_edge(5,3,14);
    add_edge(4,5,10); add_edge(5,4,10);
    add_edge(5,6,2); add_edge(6,5,2);
    add_edge(6,7,1); add_edge(7,6,1);
    add_edge(6,8,6); add_edge(8,6,6);
    add_edge(7,8,7); add_edge(8,7,7);
    add_edge(0,2,12); add_edge(2,0,12);
    add_edge(1,3,9); add_edge(3,1,9);
    add_edge(1,5,13); add_edge(5,1,13);
    add_edge(4,6,8); add_edge(6,4,8);
    add_edge(4,7,15); add_edge(7,4,15);
    add_edge(5,9,3); add_edge(9,5,3);
    add_edge(6,9,5); add_edge(9,6,5);
    add_edge(3,8,6); add_edge(8,3,6);
    add_edge(0,6,9); add_edge(6,0,9);
    add_edge(8,9,11); add_edge(9,8,11);
}
...
void test_case_2() {
    ...
    // (source, destination, weight)
    add_edge(0,1,1); add_edge(1,0,1);
    add_edge(2,3,2); add_edge(3,2,2); // 가중치 2
    add_edge(4,5,2); add_edge(5,4,2); // 가중치 2
    add_edge(0,2,3); add_edge(2,0,3);
    add_edge(1,3,4); add_edge(3,1,4); // 사이클 형성 (0-1-3-2-0)
    add_edge(5,6,4); add_edge(6,5,4);
    add_edge(0,4,5); add_edge(4,0,5); // 가중치 5
    add_edge(3,4,5); add_edge(4,3,5); // 가중치 5, 사이클 형성 가능
    add_edge(1,6,7); add_edge(6,1,7);
}
...
void test_case_3() {
    ...
    // Component 1
    add_edge(0,1,1); add_edge(1,0,1);
    add_edge(1,2,2); add_edge(2,1,2);
    add_edge(0,2,3); add_edge(2,0,3); // 사이클 형성

    // Component 2
    add_edge(5,6,4); add_edge(6,5,4);
    add_edge(6,7,5); add_edge(7,6,5);
    add_edge(5,7,10); add_edge(7,5,10); // 사이클 형성
}
...
void test_case_4() {
    ...
    add_edge(0,1,1); add_edge(1,0,1);
    add_edge(0,2,2); add_edge(2,0,2);
    add_edge(0,3,3); add_edge(3,0,3);
    add_edge(1,3,4); add_edge(3,1,4);
    add_edge(2,3,1); add_edge(3,2,1); // (0,2,2) 보다 우선 선택됨
    add_edge(1,2,2); add_edge(2,1,2); // 사이클
    add_edge(3,4,2); add_edge(4,3,2);
    add_edge(4,5,3); add_edge(5,4,3);
    add_edge(2,5,5); add_edge(5,2,5);
    add_edge(0,5,6); add_edge(5,0,6);
}
